  ...
  return (
    <div className="container mx-auto md:px-16 px-8 py-12 ">
      ...
      <div className="mb-12">
        ...
        <h1 className="mt-5 text-3xl text-orange-400">কৃষ্ণ রায় গল্প :</h1>
        <p className="mt-3">
         কৃষ্ণ চন্দ্র রায় ঢাকার এক ছাত্র, যে সবসময় গণিত বুঝতে সমস্যায় পড়ত। স্কুলে ভালো
